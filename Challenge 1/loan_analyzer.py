...
print(f"Number of loans is :{number_of_loans}")
...
sum = sum (loan_costs)
print(f"Total Value of all Loans : {sum} ")
...
print(f"Average Value of all Loans : {sum/number_of_loans} ")
...
# Print each variable.
# YOUR CODE HERE!
#future value and remaning value
...
print(f"Remaning month :{remaining_months}")
...
elif present_value < fair_value :
 print ( "Too expensive and not worth to buy")
...
def get_present_value (future_value, remaining_months,annual_discount_rate):
    ...
    get_present_value = future_value / (1 + annual_discount_rate/12) ** remaining_months

    return get_present_value 
print(f"function [get_present_value]result {get_present_value(1,2,3)}") 
...
print(f"Inexpensive loan : {inexpensive_loans}")
